...
public class EventTypeRegistryTests
{
    ...
    private static List<(IDomainEvent Event, string ExpectedName)> CreateAllDomainEvents()
    {
        ...
        [
            ...
            (new ComplexGatewayJoinStateCreated("gw1", id, "_context._nroftoken >= 2", id), nameof(ComplexGatewayJoinStateCreated)),
            (new ComplexGatewayJoinStateTokenIncremented("gw1"), nameof(ComplexGatewayJoinStateTokenIncremented)),
            (new ComplexGatewayJoinStateFired("gw1"), nameof(ComplexGatewayJoinStateFired)),
            (new ComplexGatewayJoinStateRemoved("gw1"), nameof(ComplexGatewayJoinStateRemoved)),

    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MessageName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProcessDefinitionId = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    ProcessDefinitionKey = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Version = table.Column<int>(type: "INTEGER", nullable: false),
                    DeployedAt = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SignalName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    ProcessDefinitionKey = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ETag = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    ProcessDefinitionId = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrainId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Version = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MessageName = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    ...
                    HostActivityInstanceId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutionStartedAt = table.Column<string>(type: "TEXT", nullable: true),
                    CompletedAt = table.Column<string>(type: "TEXT", nullable: true),
                    ProcessDefinitionId = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    ParentWorkflowInstanceId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ForkInstanceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ConsumedTokenId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    HostActivityInstanceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TimerActivityId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    TimerType = table.Column<int>(type: "INTEGER", nullable: false),
                    TimerExpression = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    WorkflowInstanceId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActivityInstanceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    WorkflowInstanceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ActivityId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Assignee = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowInstanceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    IsCompleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    ChildWorkflowInstanceId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ScopeId = table.Column<Guid>(type: "TEXT", nullable: true),
                    MultiInstanceIndex = table.Column<int>(type: "INTEGER", nullable: true),
                    ActivityType = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    IsExecuting = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsCancelled = table.Column<bool>(type: "INTEGER", nullable: false),
                    CancellationReason = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    VariablesId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ...
                    ExecutionStartedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowActivityInstanceEntries_WorkflowInstances_WorkflowInstanceId",
                        column: x => x.WorkflowInstanceId,
                        principalTable: "WorkflowInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GatewayActivityInstanceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ConditionalSequenceFlowId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Result = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsEvaluated = table.Column<bool>(type: "INTEGER", nullable: false),
                    WorkflowInstanceId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowConditionSequenceStates_WorkflowInstances_WorkflowInstanceId",
                        column: x => x.WorkflowInstanceId,
                        principalTable: "WorkflowInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentVariablesId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {

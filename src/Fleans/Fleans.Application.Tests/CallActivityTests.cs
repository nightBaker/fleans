...
public class CallActivityTests : WorkflowTestBase
{
    ...
    public async Task CallActivity_ShouldCompleteParent_WhenChildCompletes()
    {
        ...
        var childProcessGrain = Cluster.GrainFactory.GetGrain<IProcessDefinitionGrain>(childWorkflow.WorkflowId);
        ...
        var parentProcessGrain = Cluster.GrainFactory.GetGrain<IProcessDefinitionGrain>(parentWorkflow.WorkflowId);

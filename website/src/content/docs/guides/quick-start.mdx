...
<Tabs syncKey="release-download-tool">
  <TabItem label="gh CLI">
    ```bash
    gh release download v0.5.0 --repo nightBaker/fleans -p 'docker-compose-*.zip'
    unzip docker-compose-v0.5.0.zip -d fleans
    cd fleans
    docker compose up -d
    ```
  </TabItem>
  <TabItem label="curl">
    ```bash
    curl -LO https://github.com/nightBaker/fleans/releases/download/v0.5.0/docker-compose-v0.5.0.zip
    unzip docker-compose-v0.5.0.zip -d fleans
    cd fleans
    docker compose up -d
    ```
...
[Releases](https://github.com/nightBaker/fleans/releases)) for `v0.5.0`. For
